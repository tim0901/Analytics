...
return function (Application $app, MiddlewareFactory $factory, ContainerInterface $container) : void {
    ...
    $app->route('/api/public/graph/{dateFrom}=>{dateTo}&{desiredColumn0}={desiredValue0}&{desiredColumn1}={desiredValue1}&{desiredColumn2}={desiredValue2}&{desiredColumn3}={desiredValue3}&{desiredColumn4}={desiredValue4}',App\Handler\GraphPageHandler::class);
